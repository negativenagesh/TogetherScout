  ...
  return (
    <div className="relative bg-black text-white selection:bg-white selection:text-black h-screen w-full overflow-y-auto snap-y snap-mandatory scroll-smooth">
      ...
      <div className="relative z-10 h-full w-full">
        ...
        {/* HERO SECTION */}
        <section className="h-screen w-full flex flex-col items-center justify-start pt-28 pb-8 px-6 text-center snap-start relative">
          <motion.div 
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          >
            ...
            {/* Inline Video Player */}
            <motion.div variants={fadeUp} className="w-full relative rounded-2xl overflow-hidden border border-white/20 shadow-[0_0_50px_rgba(255,255,255,0.1)] group flex-grow flex min-h-0 mb-6">
              <video 
                ref={videoRef}
            ...
            <motion.div variants={fadeUp} className="mb-0">
              <Link 
                to="/companies"
                className="group relative inline-flex items-center justify-center px-6 py-2.5 font-bold text-black bg-white rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 border border-white shadow-[0_0_20px_rgba(255,255,255,0.3)]"
              >
